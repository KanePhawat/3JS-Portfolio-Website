...
export default class Floor{
    ...
    setCircles(){
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0xD35A6A });
        const material2 = new THREE.MeshStandardMaterial({ color: 0x5370C6 });
        const material3 = new THREE.MeshStandardMaterial({ color: 0x36D291 });
