    ...
    secondIntro(){
        ...
        return new Promise ((resolve)=> {
            ...
            .to(this.room.position, {
                ...
                stagger: 0.07,
                ease: "back.out(1.7)",
            },"introtext").to(this.roomChildren.bed.scale,{
                x: 1,
                y: 1,
                z: 1,
                ease: "back.out(2,2)",
                ...
                ease: "back.out(2,2)",
                duration:0.5,
            },">-0.4").to(this.roomChildren.mounted_shelf.scale,{
                x: 1,
                y: 1,
                z: 1,
                ease: "back.out(2,2)",
                duration:0.5,
            },">-0.4").to(this.roomChildren.onshelf.scale,{
                x: 1,
                y: 1,
                z: 1,
                ease: "back.out(2,2)",
                duration:0.5,
            },">-0.4").to(this.roomChildren.table.scale,{
                x: 1,
                y: 1,
                z: 1,
                ease: "back.out(2,2)",
                duration:0.5,
            },">-0.3").to(this.roomChildren.ontable.scale,{
                x: 1,
                y: 1,
                z: 1,
                ease: "back.out(2,2)",
                duration:0.5,
            },">-0.3").to(this.roomChildren.screen.scale,{
                x: 1,
                y: 1,
                z: 1,
                ease: "back.out(2,2)",
            ...
            .set(this.roomChildren.iphone.scale,{
                x: 1,
                y: 1,
                z: 1,  
            })
            .to(this.roomChildren.floor_item.scale,{
                x: 1,
                y: 1,
                z: 1,
                ease: "back.out(2,2)",
                ...
                ease: "back.out(2,2)",
                duration:0.5,
            },">-0.1").to(this.roomChildren.chair.rotation,{
                y: 2 * Math.PI + Math.PI/4,
                ease: "power2.out",
                duration:1,
            })            
